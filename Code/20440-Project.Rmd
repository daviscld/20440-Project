...
higher_dc_mouse <- subset(df_mouse, mean_expr1 > mean_expr2)
lower_dc_mouse <- subset(df_mouse, mean_expr1 < mean_expr2)
higher_dc_human <- subset(df_human, mean_expr1 > mean_expr2)
lower_dc_human <- subset(df_human, mean_expr1 < mean_expr2)

high_overlap <- higher_dc_mouse[which(higher_dc_mouse$pathway %in% higher_dc_human$pathway),]
low_overlap <- lower_dc_mouse[which(lower_dc_mouse$pathway %in% lower_dc_human$pathway),]
overlap <- rbind(high_overlap, low_overlap)
