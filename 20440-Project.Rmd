...
data <- read.csv(file = '../20440-Project/ABC_WT_DKO.csv')
head(data)
...
#Sort hierarchical clustering tree arms by strength of association

#Use average Euclidean distance to cluster top-50 genes
mat_cluster_cols <- hclust(dist(t(Xtmp)), method="average")

#Define sorting function to sort clustering distances by magnitude
...
#order from sort_hclust, and providing specific font and cell sizes

plt <- pheatmap(Xtmp, color = viridis(10), 
...
pdf(paste("../20440-Project/Rep1/20440-Project/Pheatmap",".pdf", sep = ""), 
    width = 10, height = 8) 
print(plt)
dev.off()
```
